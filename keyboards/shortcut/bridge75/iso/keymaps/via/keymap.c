...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_iso(
        ...
        OU_USB,  LT(0, BT_PRF1),  LT(0, BT_PRF2),  LT(0, BT_PRF3),  LT(0, BT_PRF4),  LT(0, BT_PRF5), _______, _______, _______, _______, LT(0, OU_2P4G), _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, RM_TOGG, RM_NEXT, RM_PREV, RM_HUEU, RM_HUED, RM_SATU, RM_SATD, RM_VALU, RM_VALD, _______,          _______, _______, _______,
