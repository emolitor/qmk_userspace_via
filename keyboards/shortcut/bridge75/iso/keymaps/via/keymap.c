...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_iso(
        ...
        BT_USB,  LT(0, BT_HOST1),  LT(0, BT_HOST2),  LT(0, BT_HOST3),  LT(0, BT_2_4G), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, USBSLP,  _______,          _______,
